...
var YoutubePlayerComponent = (function () {
    ...
    YoutubePlayerComponent.prototype.clicked = function () {
        this.id = "VzjJR6tTx1c";
        this.title = "Mujtaba";
    ...
    YoutubePlayerComponent.prototype.openSettings = function () {
        console.log("TODO: Implement openSettings()");
    };
    YoutubePlayerComponent.prototype.clickedStop = function () {
        this.ytPlayer.stopVideo();
    };
    YoutubePlayerComponent.prototype.clickedMute = function () {
        this.ytPlayer.muteVideo();
    };
    YoutubePlayerComponent.prototype.clickedUnmute = function () {
        this.ytPlayer.unMuteVideo();
    };
    YoutubePlayerComponent.prototype.clickedTime = function () {
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], YoutubePlayerComponent.prototype, "title", void 0);
